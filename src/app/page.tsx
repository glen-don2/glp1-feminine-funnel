    ...
    <main className="min-h-screen">
      ...
      <section className="min-h-screen flex items-center justify-center px-4 py-20 relative overflow-hidden bg-gradient-to-br from-feminine-cream via-feminine-pink-light to-feminine-pink-light">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-feminine-charcoal mb-6 leading-tight">
          ...
          <Link href="/quiz" className="inline-block bg-feminine-pink hover:bg-feminine-pink-dark text-white font-semibold px-10 py-4 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-feminine-charcoal mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-feminine-cream p-6 rounded-2xl shadow-lg flex items-start gap-4">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-feminine-cream via-feminine-pink-light to-feminine-pink-light">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-feminine-pink">
      ...
      <section id="solution" className="py-20 px-4 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-feminine-cream rounded-2xl p-8 shadow-lg mb-10">
      ...
      <section className="py-20 px-4 bg-feminine-pink">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/quiz" className="inline-block bg-white hover:bg-feminine-cream text-feminine-pink-dark font-semibold px-12 py-5 rounded-full text-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
            Start My Assessment →
          </Link>
        </div>
      </section>
